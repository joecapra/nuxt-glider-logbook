;(function ($) {
	...
	function displayIgc(mapControl) {
		...
		headerTable.html('').append($('<tr></tr>').append($('<th></th>').text('Date')).append($('<td></td>').text(displayDate)))
		var headerName
		var headerIndex
	...
	$(document).ready(function () {
		...
		const igcUrl = urlParams.get('igcUrl')
